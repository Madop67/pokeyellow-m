...
; Mon back pics are all 6x6, packed as a sprite dimensions byte (width, height).
DEF BACK_PIC_WIDTH  EQU 6 ; tiles
DEF BACK_PIC_HEIGHT EQU BACK_PIC_WIDTH ; tiles
DEF BACK_SPRITE_DIMENSIONS EQU (BACK_PIC_WIDTH << 4) | BACK_PIC_HEIGHT
