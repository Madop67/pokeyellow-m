	...
	const_export MTMOONPOKECENTER_CHANSEY
	const_export MTMOONPOKECENTER_HOLDEM_DEALER
...
MtMoonPokecenter_Object:
	...
	object_event  4,  1, SPRITE_CHANSEY, STAY, DOWN, TEXT_MTMOONPOKECENTER_CHANSEY
	object_event  8,  5, SPRITE_GAMBLER, STAY, DOWN, TEXT_MTMOONPOKECENTER_HOLDEM_DEALER
