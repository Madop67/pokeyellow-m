...
ProfOakData:
; Oak's Lab
	db $FF, 66, TAUROS, 67, EXEGGUTOR, 68, ARCANINE, 69, GYARADOS, 69, NIDOKING, 71, BLASTOISE, 0
; Route 22
	db $FF, 70, TAUROS, 71, EXEGGUTOR, 72, ARCANINE, 73, GYARADOS, 73, AERODACTYL, 75, VENUSAUR, 0
; Cerulean Cave 1F
	db $FF, 74, TAUROS, 75, EXEGGUTOR, 76, ARCANINE, 77, GYARADOS, 77, SNORLAX, 79, CHARIZARD, 0
...
; Viridian Gym
	db $FF, 50, DUGTRIO, 52, MAROWAK, 53, PERSIAN, 53, NIDOQUEEN, 55, NIDOKING, 55, RHYDON, 0
...
BrunoData:
	db $FF, 53, ONIX, 54, GOLEM, 55, HITMONLEE, 55, HITMONCHAN, 56, POLIWRATH, 58, MACHAMP, 0

BrockData:
	db $FF, 10, DIGLETT, 10, GEODUDE, 11, SANDSHREW, 11, CUBONE, 12, RHYHORN, 14, ONIX, 0

MistyData:
	db $FF, 18, PSYDUCK, 18, SEEL, 18, SHELLDER, 19, STARYU, 19, HORSEA, 21, STARMIE, 0

LtSurgeData:
	db $FF, 24, VOLTORB, 24, MAGNEMITE, 25, ELECTRODE, 25, ELECTABUZZ, 26, MAGNETON, 28, RAICHU, 0

ErikaData:
	db $FF, 29, BELLSPROUT, 30, TANGELA, 31, CLEFAIRY, 32, WEEPINBELL, 32, VICTREEBEL, 34, GLOOM, 0

KogaData:
	db $FF, 44, VENONAT, 45, GOLBAT, 46, WEEZING, 47, MUK, 48, ARBOK, 50, VENOMOTH, 0

BlaineData:
	db $FF, 46, PONYTA, 48, NINETALES, 49, MAGMAR, 50, RAPIDASH, 51, RHYDON, 54, ARCANINE, 0

SabrinaData:
	db $FF, 48, SLOWBRO, 49, HYPNO, 50, KADABRA, 50, JYNX, 50, MR_MIME, 52, ALAKAZAM, 0
...
LoreleiData:
	db $FF, 53, CLOYSTER, 54, DEWGONG, 54, SLOWBRO, 55, STARMIE, 56, JYNX, 56, LAPRAS, 0
...
AgathaData:
	db $FF, 55, HAUNTER, 56, GOLBAT, 56, WEEZING, 57, MUK, 58, ARBOK, 60, GENGAR, 0

LanceData:
	db $FF, 56, DRAGONAIR, 57, PIDGEOT, 58, GYARADOS, 58, CHARIZARD, 60, AERODACTYL, 62, DRAGONITE, 0
